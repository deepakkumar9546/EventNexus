...
public class PaymentServiceImpl implements PaymentService {
    ...
    private String getUserFriendlyDeclineMessage(String declineCode, String originalMessage) {
        ...
        return switch (declineCode) {
            ...
            case "lost_card", "stolen_card" -> "This card has been reported as lost or stolen. Please use a different payment method.";
            ...
            case "currency_not_supported" -> "Your card does not support this currency. Please use a different payment method.";
            case "do_not_honor", "generic_decline" -> "Your card was declined. Please contact your bank or use a different payment method.";
            case "fraudulent" -> "This transaction was flagged as potentially fraudulent. Please contact your bank.";
            case "card_velocity_exceeded" -> "You have exceeded the number of allowed transactions. Please try again later or use a different card.";
